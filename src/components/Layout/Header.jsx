  ...
  return (
    <header className={styles.header}>
      <div className={styles.logoArea}>
        {isUserPage ? (
          <>
            <a href="/" className={styles.vLogo}>v</a>
          ...
          <a href="/" className={styles.mainLogo}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 71 24" width="66" height="20">
      ...
      <div className={styles.right}>
        ...
        {isLoggedIn ? (
          ...
          <div className={styles.profileArea} onClick={() => setMenuOpen(!menuOpen)}>
            <div className={styles.profile}>Kim</div>
            <span className={styles.dropdownArrow}>▼</span>

            {menuOpen && (
              <ul className={styles.dropdownMenu}>
                <li><a href={`/@${userid}`}>내 벨로그</a></li>
                <li><a href="#">임시 글</a></li>
                <li><a href="#">읽기 목록</a></li>
                <li><a href="#">설정</a></li>
                <li><a href="#">로그아웃</a></li>
              </ul>
            )}
